...
milkblack_tea.display_info()
green_tea.display_info()
black_tea.change_name("烏龍茶")
black_tea.change_price(50)
black_tea.change_sugar("全糖")
green_tea.change_name("玫瑰茶")
green_tea.change_price(99)
green_tea.change_sugar("微糖")
milkblack_tea.change_name("牛奶紅茶")
milkblack_tea.change_price(70)
print(" ")
print("使用副涵式更改完的顯示結果")
black_tea.display_info()
milkblack_tea.display_info()
